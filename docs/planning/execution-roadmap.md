...
1. **System Spine**
   自顶向下实现 MVP-0 walking skeleton。先用 faithful mock 打通 Event Journal、Replay、Interaction Controller、Router skeleton、Mock Adapter、Talker playback、Barge-in / Truncate 因果链。
...
- 后续可补：`docs/planning/mvp0-walking-skeleton-plan.md`
- 后续可补：修正 `docs/project-overview.md` 中关于 git metadata 的过时表述。
